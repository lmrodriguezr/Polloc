...
L<Polloc::Polloc::IOException> on parsing error.
...
L<Polloc::Polloc::Error> If not found and mandatory.
...
L<Polloc::Polloc::Error> if empty string or not properly formatted.
