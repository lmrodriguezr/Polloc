...
Polloc::LocusIO::gff3 - A LocusIO for Gff3
...
package Polloc::LocusIO::gff3;

use strict;
use Polloc::LociGroup;
use Polloc::LocusI;
use base qw(Polloc::LocusIO);
...
Creates a B<Polloc::LocusIO::gff3> object.

=head3 Returns

A L<Polloc::LocusIO::gff3> object.
...
sub gff3_line {
   ...
   defined $locus and UNIVERSAL::can($locus, 'isa') and $locus->isa('Polloc::LocusI')
...
sub _next_locus_impl {
   ...
   my $f = Polloc::LocusI->_qualify_type($family);
